...
class ConsoleResource(SyncAPIResource):
    ...
    @cached_property
    def vdbconnector(self) -> VdbconnectorResource:
        return VdbconnectorResource(self._client)
...
class AsyncConsoleResource(AsyncAPIResource):
    ...
    @cached_property
    def vdbconnector(self) -> AsyncVdbconnectorResource:
        return AsyncVdbconnectorResource(self._client)
...
class ConsoleResourceWithRawResponse:
    ...
    @cached_property
    def vdbconnector(self) -> VdbconnectorResourceWithRawResponse:
        return VdbconnectorResourceWithRawResponse(self._console.vdbconnector)
...
class AsyncConsoleResourceWithRawResponse:
    ...
    @cached_property
    def vdbconnector(self) -> AsyncVdbconnectorResourceWithRawResponse:
        return AsyncVdbconnectorResourceWithRawResponse(self._console.vdbconnector)
...
class ConsoleResourceWithStreamingResponse:
    ...
    @cached_property
    def vdbconnector(self) -> VdbconnectorResourceWithStreamingResponse:
        return VdbconnectorResourceWithStreamingResponse(self._console.vdbconnector)
...
class AsyncConsoleResourceWithStreamingResponse:
    ...
    @cached_property
    def vdbconnector(self) -> AsyncVdbconnectorResourceWithStreamingResponse:
        return AsyncVdbconnectorResourceWithStreamingResponse(self._console.vdbconnector)
