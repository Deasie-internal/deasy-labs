...
from ...types.metadata import standardize_list_params, standardize_insert_params, standardize_tag_distribution_params
from ...types.metadata.standardize_tag_distribution_response import StandardizeTagDistributionResponse
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                standardize_tag_distribution_params.StandardizeTagDistributionParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=StandardizeTagDistributionResponse,
        )
...
class StandardizeResourceWithRawResponse:
    def __init__(self, standardize: StandardizeResource) -> None:
        ...
        self.tag_distribution = to_raw_response_wrapper(
            standardize.tag_distribution,
        )
...
class AsyncStandardizeResourceWithRawResponse:
    def __init__(self, standardize: AsyncStandardizeResource) -> None:
        ...
        self.tag_distribution = async_to_raw_response_wrapper(
            standardize.tag_distribution,
        )
...
class StandardizeResourceWithStreamingResponse:
    def __init__(self, standardize: StandardizeResource) -> None:
        ...
        self.tag_distribution = to_streamed_response_wrapper(
            standardize.tag_distribution,
        )
...
class AsyncStandardizeResourceWithStreamingResponse:
    def __init__(self, standardize: AsyncStandardizeResource) -> None:
        ...
        self.tag_distribution = async_to_streamed_response_wrapper(
            standardize.tag_distribution,
        )
