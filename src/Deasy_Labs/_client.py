...
from .resources.usecase import usecase
...
class DeasyLabs(SyncAPIClient):
    ...
    usecase: usecase.UsecaseResource
    ...
    def __init__(
        ...
        *,
        ...
        This automatically infers the `bearer_token` argument from the `DEASY_LABS_BEARER_TOKEN` environment variable if it is not provided.
        """
        if bearer_token is None:
            bearer_token = os.environ.get("DEASY_LABS_BEARER_TOKEN")
        if bearer_token is None:
            raise DeasyLabsError(
                "The bearer_token client option must be set either by passing bearer_token to the client or by setting the DEASY_LABS_BEARER_TOKEN environment variable"
            )
        ...
        self.usecase = usecase.UsecaseResource(self)
...
class AsyncDeasyLabs(AsyncAPIClient):
    ...
    usecase: usecase.AsyncUsecaseResource
    ...
    def __init__(
        ...
        *,
        ...
        self.usecase = usecase.AsyncUsecaseResource(self)
...
class DeasyLabsWithRawResponse:
    def __init__(self, client: DeasyLabs) -> None:
        ...
        self.usecase = usecase.UsecaseResourceWithRawResponse(client.usecase)
...
class AsyncDeasyLabsWithRawResponse:
    def __init__(self, client: AsyncDeasyLabs) -> None:
        ...
        self.usecase = usecase.AsyncUsecaseResourceWithRawResponse(client.usecase)
...
class DeasyLabsWithStreamedResponse:
    def __init__(self, client: DeasyLabs) -> None:
        ...
        self.usecase = usecase.UsecaseResourceWithStreamingResponse(client.usecase)
...
class AsyncDeasyLabsWithStreamedResponse:
    def __init__(self, client: AsyncDeasyLabs) -> None:
        ...
        self.usecase = usecase.AsyncUsecaseResourceWithStreamingResponse(client.usecase)
