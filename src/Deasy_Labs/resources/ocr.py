...
from ..types import ocr_ingest_params, ocr_get_sync_stats_params
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                ocr_get_sync_stats_params.OcrGetSyncStatsParams,
            ),
...
class OcrResourceWithRawResponse:
    def __init__(self, ocr: OcrResource) -> None:
        ...
        self.get_sync_stats = to_raw_response_wrapper(
            ocr.get_sync_stats,
        )
...
class AsyncOcrResourceWithRawResponse:
    def __init__(self, ocr: AsyncOcrResource) -> None:
        ...
        self.get_sync_stats = async_to_raw_response_wrapper(
            ocr.get_sync_stats,
        )
...
class OcrResourceWithStreamingResponse:
    def __init__(self, ocr: OcrResource) -> None:
        ...
        self.get_sync_stats = to_streamed_response_wrapper(
            ocr.get_sync_stats,
        )
...
class AsyncOcrResourceWithStreamingResponse:
    def __init__(self, ocr: AsyncOcrResource) -> None:
        ...
        self.get_sync_stats = async_to_streamed_response_wrapper(
            ocr.get_sync_stats,
        )
