...
from ...types import (
    ...
    metadata_get_oob_tag_file_count_params,
    metadata_get_count_distributions_params,
...
from ...types.metadata_get_oob_tag_file_count_response import MetadataGetOobTagFileCountResponse
from ...types.metadata_get_count_distributions_response import MetadataGetCountDistributionsResponse
...
class MetadataResource(SyncAPIResource):
    ...
    def get_count_distributions(
        self,
        *,
        current_tree: str,
        vector_db_config: object,
        conditions: Iterable[metadata_get_count_distributions_params.Condition] | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                metadata_get_count_distributions_params.MetadataGetCountDistributionsParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=MetadataGetCountDistributionsResponse,
        )
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                metadata_get_oob_tag_file_count_params.MetadataGetOobTagFileCountParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=MetadataGetOobTagFileCountResponse,
        )
...
class AsyncMetadataResource(AsyncAPIResource):
    ...
    async def get_count_distributions(
        self,
        *,
        current_tree: str,
        vector_db_config: object,
    ...
    async def get_oob_tag_file_count(
        self,
        *,
        vector_db_config: object,
        conditions: Iterable[TagConditionParam] | NotGiven = NOT_GIVEN,
...
class MetadataResourceWithRawResponse:
    def __init__(self, metadata: MetadataResource) -> None:
        ...
        self.get_count_distributions = to_raw_response_wrapper(
            metadata.get_count_distributions,
        )
        ...
        self.get_oob_tag_file_count = to_raw_response_wrapper(
            metadata.get_oob_tag_file_count,
        )
...
class AsyncMetadataResourceWithRawResponse:
    def __init__(self, metadata: AsyncMetadataResource) -> None:
        ...
        self.get_count_distributions = async_to_raw_response_wrapper(
            metadata.get_count_distributions,
        )
        ...
        self.get_oob_tag_file_count = async_to_raw_response_wrapper(
            metadata.get_oob_tag_file_count,
        )
...
class MetadataResourceWithStreamingResponse:
    def __init__(self, metadata: MetadataResource) -> None:
        ...
        self.get_count_distributions = to_streamed_response_wrapper(
            metadata.get_count_distributions,
        )
        ...
        self.get_oob_tag_file_count = to_streamed_response_wrapper(
            metadata.get_oob_tag_file_count,
        )
...
class AsyncMetadataResourceWithStreamingResponse:
    def __init__(self, metadata: AsyncMetadataResource) -> None:
        ...
        self.get_count_distributions = async_to_streamed_response_wrapper(
            metadata.get_count_distributions,
        )
        ...
        self.get_oob_tag_file_count = async_to_streamed_response_wrapper(
            metadata.get_oob_tag_file_count,
        )
