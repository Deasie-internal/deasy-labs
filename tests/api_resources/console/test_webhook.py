...
class TestWebhook:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_handle_stripe(self, client: Deasy) -> None:
        webhook = client.console.webhook.handle_stripe()
        assert_matches_type(object, webhook, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_handle_stripe(self, client: Deasy) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_handle_stripe(self, client: Deasy) -> None:
...
class TestAsyncWebhook:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_handle_stripe(self, async_client: AsyncDeasy) -> None:
        webhook = await async_client.console.webhook.handle_stripe()
        assert_matches_type(object, webhook, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_handle_stripe(self, async_client: AsyncDeasy) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_handle_stripe(self, async_client: AsyncDeasy) -> None:
